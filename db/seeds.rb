...
if Rails.env.development?
    ...
    [
      {
        ...
        credit_hour_maximum: 5,
        tuition_cost: 1863.00
      },
      {
        name: "6-11 Credits",
        credit_hour_minimum: 6,
        credit_hour_maximum: 11,
        tuition_cost: 3726.00
      },
      {
        name: "12-18 Credits",
        credit_hour_minimum: 12,
        credit_hour_maximum: 18,
        tuition_cost: 5589.00
      }
    ]
  )
  ...
  ccc_courses.each do |ccc_course|
    ...
    TransferableCourse.create!(from_course: ccc_course, to_course: depaul_course)
  end
  ...
  uic_courses.each do |uic_course|
    ...
    TransferableCourse.create!(from_course: uic_course, to_course: depaul_course)
  end
  ...
  ccc_courses.each do |ccc_course|
    ...
    TransferableCourse.create!(from_course: ccc_course, to_course: uic_course)
  end
